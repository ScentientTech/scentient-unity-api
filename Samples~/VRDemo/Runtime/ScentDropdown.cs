...
public class ScentDropdown : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        m_scentientDevice.scentTable.loadSucessfulEvent += OnScentTableLoaded;
    ...
    {
        Debug.Log("Scentient: scent table loaded");
    }
    ...
    private void OnChannelScentsUpdated(int channel, int scentId, string scentName)
    {
        Debug.Log("Scentient: scent channel updated");
